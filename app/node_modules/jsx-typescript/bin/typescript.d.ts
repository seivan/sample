...
declare module "typescript" {
    ...
    type CallLikeExpression = JSXElement | CallExpression | NewExpression | TaggedTemplateExpression;
    ...
    interface JSXText extends LiteralExpression {
        _jsxTextExpressionBrand: any;
    }
    interface JSXElement extends PrimaryExpression, Declaration {
        openingElement: JSXOpeningElement;
        children?: NodeArray<JSXElement | JSXExpression | JSXText>;
        closingElement?: JSXClosingElement;
        isCertainlyJSXElement: boolean;
    }
    interface JSXTag extends LeftHandSideExpression {
        name: EntityName;
    }
    ...
    interface JSXExpression extends PrimaryExpression {
        expression?: Expression;
    }
...
declare module "typescript" {
    ...
    function getClosingTags(sourceText: string, languageVersion: ScriptTarget): number[];
